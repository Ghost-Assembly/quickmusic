...
const site = 'https://ghost-assembly.github.io/quickmusic/';
const repo = 'https://github.com/Ghost-Assembly/quickmusic';
...
test('loads every asset from its own origin, without errors', async ({
    ...
    await expect(page).toHaveTitle('QuickMusic · Ghost Assembly');
});
