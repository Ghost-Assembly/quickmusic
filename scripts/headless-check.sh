...
# it shows changes, which is how the hooks below see the tile follow along:
...
after_enable() {
    ...
    # Left running, so the second enable finds it already on the bus rather
