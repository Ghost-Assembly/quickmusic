...
# Put a fake MPRIS player on the session bus, for trying the extension by hand
fake-player:
    gjs -m scripts/fake-player.js
...
logs:
    journalctl -f -o cat /usr/bin/gnome-shell | grep -i --line-buffered "quickmusic"
